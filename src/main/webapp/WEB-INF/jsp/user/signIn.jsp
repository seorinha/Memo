...
<div class="d-flex justify-content-center">
	<div class="login-box">
		...
		<form id="loginForm" action="/user/sign-in" method="post">
			...
			<input type="submit" id="loginBtn" class="btn btn-block btn-primary"
				value="로그인"> <a class="btn btn-block btn-dark"
				href="/user/sign-up-view">회원가입</a>
		</form>
	</div>
</div>
...
<script>
	$(document).ready(function() {
		...
		$('#loginForm').on('submit', function(e) {
			...
			console.log(url);
			let params= $(this).serialize(); //name속성이 반드시 있어아 쓸 수 있다
			console.log(params);
